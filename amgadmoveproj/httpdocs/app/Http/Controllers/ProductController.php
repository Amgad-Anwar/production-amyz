...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        $shipping_cats = Catshipping::all();
        $categories = Category::where('parent_id', 0)
            ->where('digital', 0)
            ->with('childrenCategories')
            ->get();

        return view('backend.product.products.create', compact('categories' , 'shipping_cats'));
    }
    ...
    public function store(ProductRequest $request)
    {
        ...
        $product->update(['catshipping_id' => $request->catshipping_id]);
    ...
    public function admin_product_edit(Request $request, $id)
    {
        ...
        $categories = Category::where('parent_id', 0)
            ...
            ->with('childrenCategories')
            ->get();
        return view('backend.product.products.edit', compact('product', 'categories', 'tags', 'lang' , 'shipping_cats'));
    }
