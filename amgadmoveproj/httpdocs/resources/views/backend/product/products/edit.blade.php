            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row" id="brand">
                            <label class="col-lg-3 col-from-label">Choose Shipping Category</label>
                            <div class="col-lg-8">
                                <select class="form-control aiz-selectpicker" name="catshipping_id" id="brand_id" data-live-search="true" required>
                                    <option value="">--select--</option>
                                    @foreach ($shipping_cats as $brand)
                                    <option value="{{$brand->id}}" @if($product->catshipping_id == $brand->id) selected @endif>{{ $brand->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
