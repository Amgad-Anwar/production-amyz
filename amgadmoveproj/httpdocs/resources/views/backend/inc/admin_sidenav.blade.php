                            ...
                            @canany(['shipping_configuration','shipping_country_setting','manage_shipping_states','manage_shipping_cities','manage_zones','manage_carriers'])
                                <li class="aiz-side-nav-item">
                                    ...
                                    <ul class="aiz-side-nav-list level-3">
                                        ...
                                        @endcan
                                        <li class="aiz-side-nav-item">
                                            <a href="{{url("show/catshipping")}}" class="aiz-side-nav-link ">
                                                <span class="aiz-side-nav-text">Shipping Categories</span>
                                            </a>
                                        </li>

                                        <li class="aiz-side-nav-item">
                                            <a href="{{url("show/shippingprice")}}" class="aiz-side-nav-link ">
                                                <span class="aiz-side-nav-text">Shipping cost per category</span>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
