...
@section('content')
    <section class="mb-4 pt-3">
        <div class="container">
                ...
                @if(isset($detailedProduct->category->parentCategory->parentCategory->id))
                <li class="text-dark fw-600 breadcrumb-item">
                    <a class="text-reset" href="{{ route('products.category', \App\Models\Category::find($detailedProduct->category->parentCategory->parentCategory->id)->slug) }}">"{{ \App\Models\Category::find($detailedProduct->category->parentCategory->parentCategory->id)->getTranslation('name') }}"</a>
                </li>
               @endif

                @if(isset($detailedProduct->category->parentCategory->id))
                <li class="text-dark fw-600 breadcrumb-item">
                    <a class="text-reset" href="{{ route('products.category', \App\Models\Category::find($detailedProduct->category->parentCategory->id)->slug) }}">"{{ \App\Models\Category::find($detailedProduct->category->parentCategory->id)->getTranslation('name') }}"</a>
                </li>
               @endif

                @if(isset($detailedProduct->category->id))
                    <li class="text-dark fw-600 breadcrumb-item">
                        <a class="text-reset" href="{{ route('products.category', \App\Models\Category::find($detailedProduct->category->id)->slug) }}">"{{ \App\Models\Category::find($detailedProduct->category->id)->getTranslation('name') }}"</a>
                    </li>
                @endif
                @if(isset($detailedProduct->name))
                <li class="text-dark fw-600 breadcrumb-item">
                    <a class="text-reset" href="#">"{{ $detailedProduct->name }}"</a>
                </li>
               @endif
            </ul>
