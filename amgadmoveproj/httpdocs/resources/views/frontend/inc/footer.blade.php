<section class="bg-white border-top mt-auto">
    <div class="container">
        <div class="row no-gutters">
            ...
            <div class="col-lg-3 col-md-6">
                <a class="text-reset border-left text-center p-4 d-block" href="https://amyz.com.eg/about">
                    <i class="la la-support la-3x text-primary mb-2"></i>
                    <h4 class="h6">{{ translate('About Us') }}</h4>
                </a>
            </div>
            <div class="col-lg-3 col-md-6">
        ...
        <div class="row">
            <div class="col-lg-5 col-xl-4 text-center text-md-left">
                <div class="mt-4">
                    ...
                    <div style="display: flex;justify-content: center;" class="w-300px mw-100 mx-auto mx-md-0">
