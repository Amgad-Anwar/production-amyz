...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NQ864KM"
...
})(window,document,'script','dataLayer','GTM-NQ864KM');</script>
	
	<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-J5LTL8F6V8"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-J5LTL8F6V8');
</script>
