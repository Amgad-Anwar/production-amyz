                                ...
                                <div class="col-2 col-lg-auto d-xl-none mb-lg-3 text-right">
								   ...
								   @php
                                    ...
                                    if (!empty($category_id)) {
                                       ...
                                       $productsxx = \App\Models\Product::where($conditions);

                                       $productsxx  =  $productsxx->whereIn('category_id', $category_ids)->get();

                                        foreach ($productsxx as $product) {
                                            if (!empty($product->brand->id)) {
                                                $brands_array[$product->brand->id] = $product->brand->id;
                                            }
                                        }

                                        $brands = \App\Models\Brand::whereIn('id', $brands_array)->get();
