...
use App\Http\Controllers\CatshippingController;
...
Route::get('/show/catshipping' , [CatshippingController::class , 'showAll']);
Route::get('/delete/catshipping/{id}' , [CatshippingController::class , 'delete']);
Route::post('/update/catshipping/{id}' , [CatshippingController::class , 'update']);
Route::post('/add/catshipping' , [CatshippingController::class , 'store']);


Route::get('/show/shippingprice' , [ShippingpriceController::class , 'showAll']);
Route::get('/delete/shippingprice/{id}' , [ShippingpriceController::class , 'delete']);
Route::post('/update/shippingprice/{id}' , [ShippingpriceController::class , 'update']);
Route::post('/add/shippingprice' , [ShippingpriceController::class , 'store']);
...
Route::get('/amyzlogin', [AdminController::class, 'admin_dashboard'])->name('admin.dashboard')->middleware(['auth', 'admin']);
