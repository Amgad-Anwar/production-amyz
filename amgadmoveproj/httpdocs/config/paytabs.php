...
return [
    ...
    'profile_id' => env('paytabs_profile_id', "99337"),
   ...
   */
    ...
    'server_key' => env('paytabs_server_key', "SJJNGGTR92-JDNBMJ969B-TNZRK6DZDB"),
   ...
   */
    ...
    'callback' => env('paytabs_ipn_callback', 'callback_url' ),
